  ...
  { 
    ...
    icon: (
      <svg
          ...
          className="h-6 w-6 fill-current text-muted-foreground transition-colors hover:text-primary"
      >
          <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.65 4.28 1.7.03 1.28.01 2.57-.02 3.84-.66-.02-1.32-.04-1.98-.07-2.14-.1-4.25-.55-6.17-1.41a10.2 10.2 0 01-3.35-2.88-10.4 10.4 0 01-1.95-4.22c-.02-.66-.03-1.32-.02-1.98.65.01 1.3.03 1.95.05A10.22 10.22 0 0112.525.02zM10.91 9.22c.11 2.2.97 4.24 2.53 5.86 1.54 1.6 3.6 2.43 5.76 2.53.01.66.02 1.32.02 1.98-.66.01-1.32.02-1.98.01-2.47-.15-4.88-1-6.95-2.4a10.15 10.15 0 01-3.23-3.72C6.18 11.83 5.9 9.35 6.13 6.9c.02-.66.01-1.32.02-1.98.66.01 1.32.02 1.98.02.53.01 1.05.06 1.57.14.39.07.78.16 1.16.27-.01.66-.02 1.32-.02 1.98z" />
      </svg>
    )
  },
  { 
