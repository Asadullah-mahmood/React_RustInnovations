  ...
  { 
    ...
    icon: (
        <svg 
            ...
            className="h-6 w-6 fill-current text-muted-foreground transition-colors hover:text-primary"
        >
            <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.03-4.83-.95-6.43-2.98-1.55-1.99-2.01-4.48-1.15-6.72.78-2.05 2.72-3.55 4.88-4.03.14-.03.28-.04.42-.04.57 0 1.13.01 1.7.01.01-1.52.01-3.04.01-4.57.01-.52-.18-1.03-.51-1.42-.39-.45-.94-.7-1.51-.7-.42 0-.83.12-1.19.34-.35.22-.66.52-.92.86-.31.39-.7.66-1.15.76-.44.1-1.04.01-1.48-.22-.36-.18-.67-.48-.9-.81-.23-.33-.4-.7-.53-1.08-.16-.48-.24-.98-.24-1.48 0-2.42 1.86-4.38 4.28-4.38 1.8 0 3.36.99 4.12 2.53z"></path>
        </svg>
    )
  },
  { 
