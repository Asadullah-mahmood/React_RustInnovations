...
export function WhatsappFAB({ phoneNumber }: { phoneNumber: string }) {
    ...
    const fabVariants = {
        ...
        animate: { scale: 1, opacity: 1, transition: { delay: 0.5, type: 'spring', stiffness: 300, damping: 20 } },
    };
    ...
    return (
        ...
        >
            <Link href={`https://wa.me/${phoneNumber.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer">
                <motion.div
