...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    id: '7',
    name: 'Farhan Kabeer',
    title: '7. Operational Manager (Pakistan)',
    imageUrl: PlaceHolderImages.find(p => p.id === 'team-member7')!.imageUrl,
    imageHint: PlaceHolderImages.find(p => p.id === 'team-member7')!.imageHint,
  },
  {
    id: '8',
    name: 'Rubab Gull',
    title: '8. Global Marketing Director',
    imageUrl: PlaceHolderImages.find(p => p.id === 'team-member8')!.imageUrl,
    imageHint: PlaceHolderImages.find(p => p.id === 'team-member8')!.imageHint,
  },
];
